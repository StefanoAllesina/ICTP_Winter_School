...
r <- runif(6)
ag <- build_assembly_graph(r, A)
plot_assembly_graph(ag$graph, ag$info)
```

Community "29" is composed of species 1, 3, 4, 5. We can assemble this state without extinctions starting from the bare ground: first invade with species 3, sending the community to state "8"; then, add species 4, moving the state to "12"; then add species 5, moving to "28", and finally add species 1, reaching "29".
...
Let's add $0.3$ to the diagonal (such that the last species has almost no self-regulation)---this shifts all of the eigenvalues:
